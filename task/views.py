...
def VCliente(request):
    ...
    return render(request,'task/v-cliente.html', {'Clientes': Clientes, 'length':length})
...
def EditSegur(request, id):
    ...
    if(request.method == 'POST'):
        ...
        if(form.is_valid()):
            ...
            return render(request,'task/edit-seguros.html', {'form': form, 'task': task})
...
def NewSegur(request):
    ...
    if request.method == 'POST':
        ...
        form = ClienteForm()
        return render(request, 'task/new-segur.html', {'form': form})
