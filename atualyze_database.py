...
def DbDb():
    ...
    def cria_cliente(prod_id_name, name, secure_id_name, cpf, cnpj, agency_id_name, policy, amount_paid,date_contract, tel1, cel1, tel2, cel2, comments, date_today):
        ...
        qsl_datas = f"""
                    INSERT INTO task_cliente(name,cpf,cnpj,conta,gerency,policy,amount_paid,tel1,tel2,cel1,cel2,email,comments,date_contract,update_at,create_at,agency_id,prod_id,secure_id)
    ...
    df = pd.read_excel('RENOVACAO.xlsx')
